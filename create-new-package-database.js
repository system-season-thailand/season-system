...
let allGoogleSheetScriptURL = 'https://script.google.com/macros/s/AKfycbyQadlBcVqZUnvrMX7eqIK1Oj-bbe0H6dVClVDO1zOSqI5ASVZTG7KDjptAIxGL_n2P6w/exec';
...
let allPackagesGoogleSheetURL = 'https://script.google.com/macros/s/AKfycbyQadlBcVqZUnvrMX7eqIK1Oj-bbe0H6dVClVDO1zOSqI5ASVZTG7KDjptAIxGL_n2P6w/exec';
...
function createH3Element(packageName) {
    ...
    if (h3Element.innerText === "Name") {
        ...
        h3Element.style.pointerEvents = 'none';
    } else {
