...
function monitorPasswordPrompt() {
    ...
    // Reload if the password prompt is removed before the password is verified
    if (!passwordPrompt && localStorage.getItem("websitePass") !== correctPassword) {
        alert("تم إكتشاف دخول غير مصرح له.. جاري اعادة تحميل الصفحة");
        location.reload();
    }
}

// Run DOM monitoring at regular intervals
setInterval(monitorPasswordPrompt, 1000);
...
window.addEventListener('load', () => {
    ...
    const storedPassword = localStorage.getItem("websitePass");
...
adultPackagePersonAmountInputOptions.forEach(option => {
    option.addEventListener('click', () => {
        ...
        if (option.textContent === 'حذف') {
            adultPackagePersonAmountInput.value = ''; // Set input value as '' if the 'حذف' h3 is clicked

            /* Delete the package infant amount for later use when importing */
            document.getElementById('store_google_sheet_package_adult_amount_value').innerText = '';


            /* Set the value inside both inputs based on the whole package person amount */
            ...
            /* Create a variable to store the whole package person amount value */
            let wholePackagePersonAmountValue;

            if (option.textContent === '1 بالغ') {
                wholePackagePersonAmountValue = 'شخص واحد';

            } else if (option.textContent === '2 بالغين') {
                wholePackagePersonAmountValue = 'شخصين';

            } else if (option.textContent === '3 بالغين') {
                wholePackagePersonAmountValue = 'ثلاثة أشخاص';

            } else if (option.textContent === '4 بالغين') {
                wholePackagePersonAmountValue = 'اربعة أشخاص';

            } else if (option.textContent === '5 بالغين') {
                wholePackagePersonAmountValue = 'خمسة أشخاص';

            } else if (option.textContent === '6 بالغين') {
                wholePackagePersonAmountValue = 'ستة أشخاص';

            } else if (option.textContent === '7 بالغين') {
                wholePackagePersonAmountValue = 'سبعة أشخاص';

            } else if (option.textContent === '8 بالغين') {
                wholePackagePersonAmountValue = 'ثمانية أشخاص';

            } else if (option.textContent === '9 بالغين') {
                wholePackagePersonAmountValue = 'تسعة أشخاص';

            } else if (option.textContent === '10 بالغين') {
                wholePackagePersonAmountValue = 'عشرة أشخاص';

            } else if (option.textContent === '11 بالغ') {
                wholePackagePersonAmountValue = 'احد عشر شخص';

            } else if (option.textContent === '12 بالغ') {
                wholePackagePersonAmountValue = 'اثنا عشر شخص';

            } else if (option.textContent === '13 بالغ') {
                wholePackagePersonAmountValue = 'ثلاثة عشر شخص';

            } else if (option.textContent === '14 بالغ') {
                wholePackagePersonAmountValue = 'اربعة عشر شخص';

            } else if (option.textContent === '15 بالغ') {
                wholePackagePersonAmountValue = 'خمسة عشر شخص';

            } else if (option.textContent === '20 بالغ') {
                wholePackagePersonAmountValue = 'عشرين شخص';

            } else if (option.textContent === '25 بالغ') {
                wholePackagePersonAmountValue = 'خمسة وعشرين شخص';

            } else if (option.textContent === '30 بالغ') {
                wholePackagePersonAmountValue = 'ثلاثين شخص';

            } else if (option.textContent === '35 بالغ') {
                wholePackagePersonAmountValue = 'خمسة وثلاثين شخص';

            } else if (option.textContent === '40 بالغ') {
                wholePackagePersonAmountValue = 'اربعين شخص';

            } else if (option.textContent === '45 بالغ') {
                wholePackagePersonAmountValue = 'خمسة واربعين شخص';

            } else if (option.textContent === '50 بالغ') {
                wholePackagePersonAmountValue = 'خمسين شخص';

            }


            /* Set the value inside both inputs based on the whole package person amount */
            document.getElementById('sms_card_with_internet_amount_input_id').value = `شرائح إنترنت ل${wholePackagePersonAmountValue}`;
...
kidsPackagePersonAmountInputOptions.forEach(option => {
    option.addEventListener('click', () => {
        ...
        if (option.textContent === 'حذف') {
            kidsPackagePersonAmountInput.value = ''; // Set input value as '' if the 'حذف' h3 is clicked
            ...
            kidsPackagePersonAmountInput.value = option.textContent; // Set input value to selected option
